...
function generer_galleri($code_categorie){
	...
	while ($donnees = $reponse->fetch()){
		...
		$galleri.= "\t\t</a>\n\t\t<figcaption itemprop=\"caption description\">".$donnees['cim']."<br/>".$donnees['descr']."</figcaption>\n"; /**Description***/
		$galleri.= "\t\t<p class=\"text-center\"><span class=\"lead\">".$donnees['cim']."</span><br/>".$donnees['descr']."</p>\n"; /**Description***/
		$galleri.= "\t</figure>\n";
	}
	$galleri.= "</div>";
	return $galleri;
